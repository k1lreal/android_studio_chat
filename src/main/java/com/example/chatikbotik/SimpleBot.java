...
public class SimpleBot {
    ...
    private static final Map<String, String> PATTERNS_FOR_ANALYSIS = new HashMap<String, String>() {{
        // hello
        put("хай", "hello");
        put("привет", "hello");
        put("здорово", "hello");
    ...
    private static final Map<String, String> ANSWERS_BY_PATTERNS = new HashMap<String, String>() {{
        ...
        if (ai) {
            ...
            for (Map.Entry<String, String> o : PATTERNS_FOR_ANALYSIS.entrySet()) {
                ...
                if (pattern.matcher(message).find())
                    return o.getValue().equals("whattime") ? date.toString() : ANSWERS_BY_PATTERNS.get(o.getValue());
            }
        }
        return say;
    }
